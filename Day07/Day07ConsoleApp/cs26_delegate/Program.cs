...
namespace cs26_delegate
{
    ...
    delegate int Compare(int a, int b);  // a, b 중 뭐가 큰지(작은지) 비교 대리자
    ...
    class Calc
    {
        ...
        // 프로그램 실행중에는 언제든지 접근 가능 (private(x))
    ...
    internal class Program
    {
        ...
        //오름차순, 내림차순 정렬 하나의 메스드에서 다 실행 가능
        ...
        static void Main(string[] args)
        {
            ...
            //res = normalCalc.Minus(x, y);  // 안됨 -> static 이므로
            res = Calc.Minus(x, y);
