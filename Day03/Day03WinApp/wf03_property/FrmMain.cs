...
namespace wf03_property
{
    public partial class FrmMain : Form
    {
        ...
        {
            GbxMain.Text = "컨트롤 학습";
            var fonts = FontFamily.Families.ToList();  // 내 OS 폰트 이름들 가져오기
        ...
        private void ChangeFontStyle()
        {
            ...
            {
                CboFontFamily.SelectedIndex = 275;  // 기본 나눔고딕
            }
        ...
        private void BtnModal_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();  // 모달방식으로 자식창 새로 띄우기
        }
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            frm.Show();  // 모달리스방식으로 자식창 띄우기 (자식창 안꺼도 부모창 접근가능) 
        }
        ...
        private void BtnMsgBox_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(TxtResult.Text, "메시지창", MessageBoxButtons.YesNo, 
                            MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2);  // 기본포커스 버튼 설정
            //MessageBox.Show(TxtResult.Text, "메시지창", MessageBoxButtons.YesNo, 
                            //MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2, MessageBoxOptions.RightAlign);  // 오른쪽 정렬
        }
        ...
        private void BtnAddChild_Click(object sender, EventArgs e)
        {
            if (TrvDummy.SelectedNode != null)
            {
                ...
                TrvDummy.SelectedNode.Expand();  // 트리노드 하위것 펼쳐주기 (반대로 -> .Collapse)
                TreeToList();
            }
        }
        void TreeToList()
