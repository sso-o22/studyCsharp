...
namespace cs14_deepcopy
{
    class SomeClass
    {
        ...
        public SomeClass DeepCopy()
        {
            ...
            newCopy.SomeField2 = SomeField2;  // this 안써도 됨
    ...
    class Employee
    {
        ...
        {
            this.Name = Name;  // 멤버변수(속성)과 메서드의 매개변수이름이 대소문자까지 완전히 똑같을 때
        }
    }
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("얕은 복사 시작");  // source와 target의 (주소복사) 값이 share(!)
